...
% for behid = 1:58
% % read each beh
% beh_father = 'D:\Data\KRR_data\beh_data';
% beh_path = ['D:\Data\KRR_data\beh_data\beh_reg_ICDF_922_' num2str(behid) '.txt'];
% scores = load(beh_path);
% save('D:\Data\KRR_data\scores.csv', 'scores');
for i = 1:60
addpath(genpath('D:\Data\Standalone_Ooi2022_MMP-main\Standalone_Ooi2022_MMP-main\utilities\matlab\predictive_models\KernelRidgeRegression'));
addpath(genpath('D:\Data\Standalone_Ooi2022_MMP-main\Standalone_Ooi2022_MMP-main\utilities\matlab\predictive_models\utilities'));
addpath(genpath('D:\Data\Standalone_Ooi2022_MMP-main\Standalone_Ooi2022_MMP-main\utilities\matlab\utilities'));
addpath(genpath('D:\Data\Standalone_Ooi2022_MMP-main\Standalone_Ooi2022_MMP-main\utilities\matlab\stats'));
addpath(genpath('D:\Data\Standalone_Ooi2022_MMP-main\Standalone_Ooi2022_MMP-main\utilities\matlab'));

outerFolds = 10;
innerFolds = 10;
feature_path = 'D:\Data\KRR_data\features_rs'; % mat文件，7200*921
featurebase = 'rs_';
split = i;
outdir = 'D:\Data\KRR_data\KRR_results';
subtxt = 'D:\Data\fc-re\HCP_922.txt'; % 被试list
scorecsv = 'D:\Data\KRR_data\scores.csv'; % 行为，921*58
restrictedcsv = 'D:\Data\KRR_data\HCP_restricted.csv'; % 年龄和家庭信息
predvar = 'D:\Data\KRR_data\prediction_variables.txt'; % 行为的名字
...
if ~exist(fullfile(outdir, y_mat))
    ...
    y = load('D:\Data\KRR_data\scores.txt');
else
...
% end
cov = load('D:\Data\KRR_data\output_cov.mat');
